          ...
          {!selectedPost ? (
            ...
            >
              ...
              <div className="text-center mb-16">
                ...
                <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent italic">
                            ...
                            <div className="mt-auto flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-[9px] text-muted-foreground font-bold mt-0.5 flex items-center gap-1">
            ...
            >
              <button
                ...
                className="flex items-center gap-2 text-muted-foreground hover:text-white mb-12 transition-colors font-bold uppercase tracking-widest text-xs group"
              >
                <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
                Zurück zur Übersicht
              </button>

              <article className="glass-strong rounded-[3rem] border border-white/10 overflow-hidden shadow-2xl">
                {selectedPost.cover_image && (
                  <div className="w-full h-[400px] overflow-hidden border-b border-white/10">
                    <img 
                      src={selectedPost.cover_image.startsWith('http') ? selectedPost.cover_image : `${API_URL}${selectedPost.cover_image}`} 
                ...
                <div className="p-8 md:p-16">
                   <div className="flex flex-wrap items-center gap-4 mb-8">
                    {(() => {
                      const cfg = TYPE_CONFIG[selectedPost.post_type] || TYPE_CONFIG.dev;
                      return (
                        <span className={cn(
                    ...
                    <span className="text-xs text-muted-foreground font-bold flex items-center gap-2">
                      ...
                      {selectedPost.view_count || 0} Aufrufe
                    </span>
                  </div>
